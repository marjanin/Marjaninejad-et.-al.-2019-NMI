function [q1_system, q2_system] = physical_limit_cycle_gen_fcn(features,each_feature_length)
...
q1_scaled=((q1_raw)*65)+68; % [0 130]%
q2_scaled=((q2_raw)*47.5)+297.5;% [255-362];-fix these_ranges based on the training data on the abbling;
...
q2_system=q2_filtered; % the system's q2 is defined as the angle between the second limb and the vertical line (q1+q2 based on joint angles)
% close all
