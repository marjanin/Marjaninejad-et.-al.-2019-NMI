...
fs=framespersec;
pass_chance=1/fs;max_force=12;min_force=0;% max force was 12
...
%save(['../results/Aug31_100Hz_',num2str(T),'seconds_systemID_tendondriven_babbling_data.mat']);
...
%save(['../results/Aug31_100Hz_',num2str(T),'seconds_babbling_Kinematics_and_Forces.mat'],'Kinematics','Forces','tspan');
%% NN model
layers=[15];
[net, tr] = NN_model_fcn(Kinematics, Forces,layers);
%% Saving all the data
%save(['../results/Aug31_100Hz_',num2str(T),'seconds_systemID_tendondriven_babbling_model.mat']);
end
