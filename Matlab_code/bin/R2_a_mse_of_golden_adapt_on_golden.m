...
for run_no_cntr=1:run_no
    ...
    for adapt_no_cntrl=1:adapt_no
        ...
        new_features = new_rand_features;
...
for run_no_cntr=1:run_no
    ...
    for adapt_no_cntrl=1:adapt_no
        ...
        cum_pattern_run_kinematics = [cum_pattern_run_kinematics; new_pattern_run_kinematics];
        cum_input_force_values = [cum_input_force_values new_input_force_values];     
        mse_results2(run_no_cntr,adapt_no_cntrl)=sum((new_desired_angs_and_locs(1,:)-new_real_angs_and_locs(1,:)).^2)+sum((new_desired_angs_and_locs(2,:)-new_real_angs_and_locs(2,:)).^2);
    end
end
save('R2_a_results_Aug23')